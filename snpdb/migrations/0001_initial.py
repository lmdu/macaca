# Generated by Django 2.0 on 2017-12-13 11:54
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('funcdb', models.SmallIntegerField(choices=[(1, 'GO'), (2, 'KEGG'), (3, 'Pfam'), (4, 'InterPro')], help_text='The function database name')),
                ...
                ('category', models.SmallIntegerField(choices=[(0, ''), (1, 'molecular function'), (2, 'cellular component'), (3, 'biological process')], help_text='Function category')),
            ],
        ),
        migrations.CreateModel(
            name='Gene',
