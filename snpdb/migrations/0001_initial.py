# Generated by Django 2.0 on 2017-12-11 13:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('biotype', models.IntegerField(choices=[(1, 'protein coding'), (2, 'pseudogene'), (3, 'snRNA'), (4, 'rRNA'), (5, 'miRNA'), (6, 'miscRNA'), (7, 'snoRNA')], help_text='Gene coding types')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feature', models.IntegerField(choices=[(4, 'Intron'), (1, 'CDS'), (2, 'Exon'), (3, "3'UTR"), (5, "5'UTR")], help_text='Gene features')),
                ('gene_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='snpdb.Gene')),
            ],
        ),
        migrations.CreateModel(
            name='Snp',
            fields=[
                ...
                ('chr_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='snpdb.Chromosome')),
            ],
        ),
        migrations.CreateModel(
            name='Species',
            fields=[
                ...
                ('group', models.CharField(help_text='Group that species belongs to', max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('trans_pos', models.IntegerField(help_text='Relative position in transcript')),
                ('codon', models.CharField(help_text='SNP site codon', max_length=3)),
                ('codon_pos', models.IntegerField(help_text='The SNP base position in codon')),
                ('amino_acid', models.CharField(help_text='The amino acid for SNP codon', max_length=1)),
                ('protein_pos', models.IntegerField(help_text='Relative position of codon in protein')),
                ('snp_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='snpdb.Snp')),
            ],
        ),
        migrations.CreateModel(
            name='Transcript',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('genotype', models.IntegerField(choices=[(1, 'Homozygote'), (2, 'Heterozygote')], help_text='Alteration genotype')),
                ('snp_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='snpdb.Snp')),
                ('species_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='snpdb.Species')),
            ],
        ),
        migrations.AddField(
